...
from rag.nlp import rag_tokenizer, tokenize_table, tokenize_chunks, find_codec
...
def chunk(filename, binary=None, from_page=0, to_page=100000, lang="Chinese", callback=None, **kwargs):
    ...
    st = timer()
    chunks = naive_merge(
        sections, parser_config.get("chunk_token_num", 128), parser_config.get("delimiter", "\n!?。；！？"))
...
if __name__ == "__main__":
    ...
    pdf = "技术培训.pdf"
    # pdf = "技术培训.docx"
    chunk(pdf, from_page=0, to_page=10, callback=dummy)
