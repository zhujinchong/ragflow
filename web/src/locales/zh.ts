export default {
  translation: {
    ...
    knowledgeDetails: {
      ...
      progressMsg: '进度消息',
      testingDescription: '最后一步！ 成功后，就开始对话吧。',
    ...
    knowledgeConfiguration: {
      ...
      naive: `<p>支持的文件格式为<b>DOCX、IMAGE、PDF、TXT</b>。</p>
      <p>此方法将简单的方法应用于块文件：</p>
      <p>
      <li>系统将使用视觉检测模型将连续文本分割成多个片段。</li>
      <li>接下来，这些连续的片段被合并成Token数不超过“Token数”的块。</li></p>`,
      paper: `<p>支持的文件格式为<b>DOCX、PDF</b>。</p><p>
      ...
      qa: ` <p>
      此块方法支持<b> xlsx/csv/txt </b>文件格式。
    </p>
    <li>
      如果文件以<b> xlsx </b>格式，没有 <b>标题</b>：第一列是问题，第二列答案。
    </li>
    <li>
      如果文件以<b> csv/txt </b>格式，没有 <b>标题</b>：一行包含问题和答案，<b>Tab制表符</b> 用作分开问题和答案的定界符。
    </li>
    <p>
      <i>
        未能遵循上述规则的文本行将被忽略。
